...
class DIEN_ME(BaseModel):
    ...
    def __init__(self,
        ...
        super(DIEN_ME, self).__init__([], dnn_feature_columns, l2_reg_linear=0, l2_reg_embedding=l2_reg_embedding,
...
class InterestEvolving(nn.Module):
    ...
    def forward(self, query, keys, keys_length, mask=None):
        ...
        query = query.unsqueeze(1) # 为导出onnx而更改
        ...
        if self.gru_type == 'GRU':
            ...
            outputs = self.interest_evolution(keys, att_scores, keys_length)
            outputs = InterestEvolving._get_last_state(outputs, keys_length) # [b, H]
